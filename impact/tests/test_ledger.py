...
def test_ledger_indexes():
    ...
    pr2 = PullRequest(
        ...
        state=PullRequestState.CLOSED,
        user=user,
        created_at=datetime(2024, 12, 3, tzinfo=UTC),
        updated_at=datetime(2024, 12, 4, tzinfo=UTC),
        closed_at=datetime(2024, 12, 4, tzinfo=UTC),
        merged_at=datetime(2024, 12, 4, tzinfo=UTC),
        merged=True,
        merge_commit_sha=None,
        repository=repo,
        base=base,
    ...
    review2 = ReviewRecord(
        ...
        body="Review",
        state=ReviewState.APPROVED,
        submitted_at=datetime(2024, 12, 3, tzinfo=UTC),
    ...
    review3 = ReviewRecord(
        ...
        body="Review",
        state=ReviewState.APPROVED,
        submitted_at=datetime(2024, 12, 5, tzinfo=UTC),
