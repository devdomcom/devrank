...
def create_app() -> FastAPI:
    ...
    # Submissions + evaluations (assessment-scoped)
    v1.include_router(submissions_router, prefix="/assessments")
    v1.include_router(evaluations_router, prefix="/assessments")
    # Impact domain
